...
const updateSingleProduct = (productId, productData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      typeof ((_a =
        productData === null || productData === void 0
          ? void 0
          : productData.inventory) === null || _a === void 0
        ? void 0
        : _a.quantity) !== "undefined"
    ) {
      const availableQuantity =
        ((_b =
          productFromDB === null || productFromDB === void 0
            ? void 0
            : productFromDB.inventory) === null || _b === void 0
          ? void 0
          : _b.quantity) +
        ((_c =
          productData === null || productData === void 0
            ? void 0
            : productData.inventory) === null || _c === void 0
          ? void 0
          : _c.quantity);
      // if quantity is getter than 0 then set inStock true
      if (availableQuantity > 0) {
        updateDoc = Object.assign(Object.assign({}, updateDoc), {
          inventory: {
            inStock: true,
            quantity:
              (_d =
                productData === null || productData === void 0
                  ? void 0
                  : productData.inventory) === null || _d === void 0
                ? void 0
                : _d.quantity,
          },
        });
    ...
    product_validation_schema_1.productUpdateValidationSchema.safeParse(
      productData,
    );
    const result = product_schema_1.Product.findOneAndUpdate(
      { _id: productId },
      updateDoc,
      {
        new: true,
